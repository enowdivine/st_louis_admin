...
function Bookings(){
    ...
    return(
        <>
            ...
            <TitleCard title="Recent Bookings" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
